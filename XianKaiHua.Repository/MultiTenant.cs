...
namespace XianKaiHua.Repository
{
    ...
    public class MultiTenant<TEntity> : IMultiTenant<TEntity> where TEntity : class, new()
    {
        #region 私有属性
        private SqlSugarClient  _multiClient;
        #endregion

        #region SqlsugarClient实体
        public ISqlSugarClient SqlSugarClient {
            get
            {
                ...
                {
                    _multiClient.ChangeDatabase(sugarTable.TableDescription.ToLower());
                }
                else
                {
        ...
        public async Task<TEntity> QueryById(object objId)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().In(objId).SingleAsync();
        }
        ...
        public async Task<TEntity> QueryById(object objId, bool blnUseCache = false)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().WithCacheIF(blnUseCache).In(objId).SingleAsync();
        }
        ...
        public async Task<List<TEntity>> QueryByIDs(object[] listIds)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().In(listIds).ToListAsync();
        }
        #endregion
        ...
        public async Task<int> Add(TEntity Entity)
        {
            ...
            var insert = SqlSugarClient.Insertable(Entity);
        ...
        {
            return await SqlSugarClient.Insertable(listEntity.ToArray()).ExecuteCommandAsync();
        }
        #endregion
        ...
        public async Task<bool> Update(TEntity Entity)
        {
            ...
            //return i > 0;
            //这种方式会以主键为条件
            return await SqlSugarClient.Updateable(Entity).ExecuteCommandHasChangeAsync();
        }

        public async Task<bool> Update(TEntity entity, string strWhere)
        {
            //return await Task.Run(() => _db.Updateable(entity).Where(strWhere).ExecuteCommand() > 0);
            return await SqlSugarClient.Updateable(entity).Where(strWhere).ExecuteCommandHasChangeAsync();
        }

        public async Task<bool> Update(string strSql, SugarParameter[] parameters = null)
        {
            //return await Task.Run(() => _db.Ado.ExecuteCommand(strSql, parameters) > 0);
            return await SqlSugarClient.Ado.ExecuteCommandAsync(strSql, parameters) > 0;
        }

        public async Task<bool> Update(object operateAnonymousObjects)
        {
            return await SqlSugarClient.Updateable<TEntity>(operateAnonymousObjects).ExecuteCommandAsync() > 0;
        }
        ...
        public async Task<bool> Update(TEntity entity,List<string> lstColumns = null,List<string> lstIgnoreColumns = null,string strWhere = "")
        {
            ...
            IUpdateable<TEntity> up = SqlSugarClient.Updateable(entity);
            if (lstIgnoreColumns != null && lstIgnoreColumns.Count > 0)
            {
        ...
        public async Task<bool> Delete(TEntity entity)
        {
            ...
            //return i > 0;
            return await SqlSugarClient.Deleteable(entity).ExecuteCommandHasChangeAsync();
        }
        ...
        public async Task<bool> DeleteById(object id)
        {
            ...
            //return i > 0;
            return await SqlSugarClient.Deleteable<TEntity>(id).ExecuteCommandHasChangeAsync();
        }
        ...
        public async Task<bool> DeleteByIds(object[] ids)
        {
            ...
            //return i > 0;
            return await SqlSugarClient.Deleteable<TEntity>().In(ids).ExecuteCommandHasChangeAsync();
        }
        #endregion
        ...
        {
            return await SqlSugarClient.Queryable<TEntity>().ToListAsync();
        }
        ...
        public async Task<List<TEntity>> Query(string strWhere)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().WhereIF(!string.IsNullOrEmpty(strWhere), strWhere).ToListAsync();
        }
        ...
        {
            return await SqlSugarClient.Queryable<TEntity>().WhereIF(whereExpression != null, whereExpression).ToListAsync();
        }
        ...
        {
            return await SqlSugarClient.Queryable<TEntity>().Select(expression).ToListAsync();
        }
        ...
        {
            return await SqlSugarClient.Queryable<TEntity>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds).WhereIF(whereExpression != null, whereExpression).Select(expression).ToListAsync();
        }
        ...
        public async Task<List<TEntity>> Query(Expression<Func<TEntity, bool>> whereExpression, string strOrderByFileds)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().WhereIF(whereExpression != null, whereExpression).OrderByIF(strOrderByFileds != null, strOrderByFileds).ToListAsync();
        }
        /// <summary>
        /// 功能描述:查询一个列表
        /// </summary>
        ...
        public async Task<List<TEntity>> Query(Expression<Func<TEntity, bool>> whereExpression, Expression<Func<TEntity, object>> orderByExpression, bool isAsc = true)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().OrderByIF(orderByExpression != null, orderByExpression, isAsc ? OrderByType.Asc : OrderByType.Desc).WhereIF(whereExpression != null, whereExpression).ToListAsync();
        }
        ...
        public async Task<List<TEntity>> Query(string strWhere, string strOrderByFileds)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds).WhereIF(!string.IsNullOrEmpty(strWhere), strWhere).ToListAsync();
        }
            ...
            string strOrderByFileds)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds).WhereIF(whereExpression != null, whereExpression).Take(intTop).ToListAsync();
        }
            ...
            string strOrderByFileds)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds).WhereIF(!string.IsNullOrEmpty(strWhere), strWhere).Take(intTop).ToListAsync();
        }
        ...
        {
            return await SqlSugarClient.Ado.SqlQueryAsync<TEntity>(strSql, parameters);
        }
        ...
        {
            return await SqlSugarClient.Ado.GetDataTableAsync(strSql, parameters);
        }
            ...
            string strOrderByFileds)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds).WhereIF(whereExpression != null, whereExpression).ToPageListAsync(intPageIndex, intPageSize);
        }
          ...
          string strOrderByFileds)
        {
            ...
            return await SqlSugarClient.Queryable<TEntity>().OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds).WhereIF(!string.IsNullOrEmpty(strWhere), strWhere).ToPageListAsync(intPageIndex, intPageSize);
        }
        ...
        public async Task<PageModel<TEntity>> QueryPage(Expression<Func<TEntity, bool>> whereExpression, int intPageIndex = 1, int intPageSize = 20, string strOrderByFileds = null)
        {
            ...
            var list = await SqlSugarClient.Queryable<TEntity>()
            ...
            Expression<Func<T, T2, T3, bool>> whereLambda = null) where T : class, new()
        {
            if (whereLambda == null)
            {
                return await SqlSugarClient.Queryable(joinExpression).Select(selectExpression).ToListAsync();
            }
            return await SqlSugarClient.Queryable(joinExpression).Where(whereLambda).Select(selectExpression).ToListAsync();
        }
            ...
            string strOrderByFileds = null)
        {
            ...
            RefAsync<int> totalCount = 0;
            var list = await SqlSugarClient.Queryable<T, T2>(joinExpression)
            ...
            string strOrderByFileds = null)
        {
            ...
            RefAsync<int> totalCount = 0;
            var list = await SqlSugarClient.Queryable<T, T2>(joinExpression).GroupBy(groupExpression)
             .Select(selectExpression)
             .OrderByIF(!string.IsNullOrEmpty(strOrderByFileds), strOrderByFileds)
             .WhereIF(whereExpression != null, whereExpression)
             .ToPageListAsync(intPageIndex, intPageSize, totalCount);
